...
def estimate_radius(magnitude, albedo = 0.1): #Equation taken from http://www.physics.sfasu.edu/astro/asteroids/sizemagnitude.html
    magic_number = 1329/2
    return (magic_number/math.sqrt(albedo))*(10**(-0.2*magnitude))

def estimate_mass(magnitude, spectral_type, albedo = 0.1): #Some equations from https://en.wikipedia.org/wiki/Standard_asteroid_physical_characteristics
