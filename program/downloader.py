...
def download_Body(number, time, mass = -1):
    ...
    return bodies.Body(number, mass, body_table['x'][0], body_table['y'][0], body_table['z'][0], body_table['vx'][0], body_table['vy'][0], body_table['vz'][0])
